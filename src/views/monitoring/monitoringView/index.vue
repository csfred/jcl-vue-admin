<template>
  <div>
    <div style="margin-left: 20px">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 18px;margin-top: 10px;margin-bottom: 10px">
        <el-breadcrumb-item><i class="el-icon-menu"></i><b> 监控画面展示</b></el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-container>
      <!--显示左边树-->
      <div width="20%" style="min-height:500px;padding-top:20px;">
        <el-aside >
          <el-tree :data="data" ref="defaultProps" v-if="data"
                   node-key="data"
      ...
      <el-main style="border-left: #e2e2e2 1px solid;padding-top:10px;">
        <ys-monitor :deviceId="deviceId" :channelId="channelId" :remarks1="remarks1" :url="url" :key="channelId"  v-if="showjiankong == '01'"></ys-monitor>
         <monitor :deviceId="deviceId" :channelId="channelId" :key="channelId" v-if="showjiankong == '02'"></monitor>
      </el-main>
    </el-container>
