  ...
  <div class="site-editor-container">
    ...
    <div class="normalMain">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="stationNo" label="任务名称"> </el-table-column>
        <el-table-column prop="stationName" label="巡检员"> </el-table-column>
        <el-table-column prop="stationName" label="线路"> </el-table-column>
        <el-table-column prop="stationName" label="任务开始时间"> </el-table-column>
        <el-table-column prop="stationName" label="任务结束时间"> </el-table-column>
        <el-table-column prop="stationName" label="状态"> </el-table-column>
        <el-table-column prop="stationName" label="隐患上报"> </el-table-column>
        <el-table-column fixed="right" label="操作">
          <template slot-scope="scope">
            <el-button type="primary" @click="showDialog(scope.row)">任务详情</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      <div class="normalMain">
        <el-table :data="deviceTableData" border>
          <el-table-column prop="stationNo" label="时间"> </el-table-column>
          <el-table-column prop="stationNo" label="设备名"> </el-table-column>
          <el-table-column prop="stationName" label="紧急程度"> </el-table-column>
          <el-table-column prop="stationName" label="上报隐患"></el-table-column>
