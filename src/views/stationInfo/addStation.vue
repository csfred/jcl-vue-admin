     ...
     <div class="">
         ...
         >
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
               ...
               <el-form-item>
                  <el-button type="primary" v-if="this.types==0" @click="submitForm('ruleForm')">立即创建</el-button>
                  <el-button type="primary" v-if="this.types==1" @click="submitForm('ruleForm')">确认修改</el-button>
...
export default {
   ...
   methods: {
      mapFn() {
         ...
         map.centerAndZoom(new BMap.Point(112.851274,35.497553), 8);  //晋城 初始化地图,设置中心点坐标和地图级别
         //添加地图类型控件
